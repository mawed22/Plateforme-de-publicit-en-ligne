...
include('pages/config.php');
 ...
 include('pages/newannonce.php');
  ...
  $count=$bdd->prepare("SELECT count(id) as cpt FROM campagnes WHERE categorie= 'Accessoires de mode' ");
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">  <?php echo $tcount[0]["cpt"]; ?> annonces dans la catégorie Accessoires de mode </h2>
              <p>
                Il s'agit de toutes les annonces de la catégorie Accessoires de mode disponibles sur ePUB+.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <?php 
         $slt = $bdd->query("SELECT * FROM campagnes WHERE categorie= 'Accessoires de mode' ");
