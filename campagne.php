          ...
          <div class="row">
              <div class="col-12">
                 <div class="full"><br><br><br><br>
                  <p style="text-align: center; color: #fff; font-size: 25px; font-weight: bold;" ><?php echo $tcount[0]["cpt"]; ?> annonces disponibles sur ePUB+</p>
                     <?php if (isset($error)) {
...
<div class="container-fluid">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <div style="">
              ...
              echo '<a class="primary-btn" data-toggle="modal" data-target="#login" style="margin-top: 20px" href="#" ><span> Nouvelle Annonce</span><i class="ti-arrow-right ml-1"></i></a>';
                ...
                <!--a class="primary-btn" data-toggle="modal" data-target="#login" style="margin-top: 20px" href="#"><span> Nouvelle Annonce</span><i class="ti-arrow-right ml-1"></i></a-->
                        <!--a class="contact_bt" href="test/courses.html">Start a Course</a-->
    ...
    <div class="popular_courses">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3"><?php echo $tcount[0]["cpt"]; ?> annonces disponibles au total </h2>
              <p>
                Il s'agit de toutes les annonces disponibles sur ePUB+.
              </p>
            </div>
          </div>
        </div>
        ...
        <?php 
         $slt = $bdd->query("SELECT * FROM campagnes ORDER BY id ASC");
