...
<?php 
     ...
     if(isset($_GET['delete'])){
             if ($id = $_GET['delete']) {
                $bdd->query("DELETE FROM newsletter WHERE id = '$id' ") or die($bdd->error());
                $success = "Cette adresse mail a été supprimé avec succès de la newsletter !!";
                }else {
            $error = "Impossible de supprimer cette adresse mail !!";
          } 
        }

 //Récupérer le nombre d'enregistrement dans la table
  $count=$bdd->prepare("SELECT count(id) as cpt FROM newsletter ");
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Plus de <?php echo $tcount[0]["cpt"]; ?> inscriptions à la newsletter </h1>
            <?php if (isset($error)) {
          ...
          <h1 style="text-align: center;">Les adresses mails de la newsletter</h1>
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <?php
              $req = $bdd->prepare("SELECT * FROM newsletter ORDER BY id ASC LIMIT $debut,$nbe ");
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo $res['phone_auteur']; ?></td>
                  <td><?php echo $res['email_auteur']; ?></td>
