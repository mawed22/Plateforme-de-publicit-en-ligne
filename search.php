...
include('pages/config.php');
  ...
  /*$count=$bdd->prepare("SELECT count(id) as cpt FROM campagnes WHERE categorie= 'Immobilier' ");
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">  Résultat pour la catégorie <?php echo $rech; ?> </h2>
              <p>
                Il s'agit de toutes les annonces de la catégorie <?php echo $rech; ?> disponibles sur ePUB+.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <?php 
         //$slt = $bdd->query("SELECT * FROM campagnes WHERE categorie LIKE '%".$_GET['search']."%' ");
         $slt = $bdd->query("SELECT * FROM campagnes WHERE categorie= '$rech' ");
