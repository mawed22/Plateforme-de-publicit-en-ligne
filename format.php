...
include('pages/config.php');
  ...
  $count=$bdd->prepare("SELECT count(id) as cpt FROM campagnes WHERE categorie= 'formations-Education' ");
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3"><?php echo $tcount[0]["cpt"]; ?> annonces dans la catégorie Formations-Education </h2>
              <p>
                Il s'agit de toutes les annonces de la catégorie formations-Education disponibles sur ePUB+.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <?php 
         $slt = $bdd->query("SELECT * FROM campagnes WHERE categorie= 'formations-Education' ");
                ...
                <!-- Tab panes -->
                    <div class="tab-pane" id="Registration">
                      <form role="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">                           
                                <div class="col-sm-10">
                                    <label>Image du produit/service</label><button type="submit" class="btn btn-primary" name="valide">
                                       Publier
                                    </button>
