...
include('pages/config.php');
  ...
  $count=$bdd->prepare("SELECT count(id) as cpt FROM campagnes WHERE categorie= 'Autres' ");
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">  <?php echo $tcount[0]["cpt"]; ?> annonces dans la catégorie Autres</h2>
              <p>
                Il s'agit de toutes les annonces de la catégorie Autres disponibles sur ePUB+.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <?php 
         $slt = $bdd->query("SELECT * FROM campagnes WHERE categorie= 'Autres' ");
                    ...
                    <div class="tab-pane" id="Registration">
                      <form role="form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Image du produit/service</label><input class="form-control"name="prix"  placeholder="Entrer le prix de votre service ou produit" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
